      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 md:col-span-2 flex md:flex-col items-start md:items-end gap-2 md:pt-4">
            <Quote size={48} className="text-white/15" />
          </div>
          <div className="col-span-12 md:col-span-8 relative min-h-[220px]">
            <AnimatePresence mode="wait">
              <motion.blockquote
                ...
                className="font-serif text-3xl md:text-5xl text-white/90 leading-[1.2] tracking-tight"
              >
                “{t.quote}”
              </motion.blockquote>
            </AnimatePresence>
            <div className="mt-10 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="w-10 h-10 border border-white/15 hover:border-white/50 flex items-center justify-center text-white/70 hover:text-white transition-all"
                  aria-label="prev"
                >
                  <ArrowLeft size={14} />
                </button>
